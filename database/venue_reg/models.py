...
class Accounts(models.Model):
    ...
    teamname = models.CharField(max_length=10, blank=True, null=True)
...
class Records(models.Model):
    ...
    acc = models.CharField(max_length=30)
    venueid = models.CharField(db_column='venueID', max_length=30)  # Field name made lowercase.
...
class Venues(models.Model):
    venueid = models.CharField(db_column='venueID', primary_key=True, max_length=20)  # Field name made lowercase.
